...
public:
    ...
    string code_restrictions_modified;
	...
	int getGlobalMinMax() const {
		return globalMinMax;
	}

	void setGlobalMinMax(int globalMinMax) {
	...
	int getTypeLoop() const {
		return typeLoop;
	}

	void setTypeLoop(int typeLoop) {
		this->typeLoop = typeLoop;
	}

	const string& getCodeRestrictionsModified() const;
	void setCodeRestrictionsModified(const string& codeRestrictionsModified);
	int getVar() const;
	void setVar(int var);
	double getX3Current() const;
	void setX3Current(double x3Current);
	double getX4Current() const;
	void setX4Current(double x4Current);
	double getX5Current() const;
	void setX5Current(double x5Current);
	int getLimitSpace() const;
	void setLimitSpace(int limitSpace);
	int getLimitSpaceConvex() const;
	void setLimitSpaceConvex(int limitSpaceConvex);
};
