...
const string& SETUP::Setup::getCodeRestrictionsModified() const {
	return code_restrictions_modified;
}

void SETUP::Setup::setCodeRestrictionsModified(
		const string& codeRestrictionsModified) {
	code_restrictions_modified = codeRestrictionsModified;
}

int SETUP::Setup::getVar() const {
	return nVar;
}

void SETUP::Setup::setVar(int var) {
	nVar = var;
}

double SETUP::Setup::getX3Current() const {
	return x3_current;
}

void SETUP::Setup::setX3Current(double x3Current) {
	x3_current = x3Current;
}

double SETUP::Setup::getX4Current() const {
	return x4_current;
}

void SETUP::Setup::setX4Current(double x4Current) {
	x4_current = x4Current;
}

double SETUP::Setup::getX5Current() const {
	return x5_current;
}

void SETUP::Setup::setX5Current(double x5Current) {
	x5_current = x5Current;
}

int SETUP::Setup::getLimitSpaceConvex() const {
	return limit_space_convex;
}

void SETUP::Setup::setLimitSpaceConvex(int limitSpaceConvex) {
	limit_space_convex = limitSpaceConvex;
}
//} /* namespace SETUP */
